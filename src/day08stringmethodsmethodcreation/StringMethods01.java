...
public class StringMethods01 {
	...
	public static void main(String[] args) {
		...
		//19) trim() method is used to delete space character from the beginning 
		...
		//My Way
		System.out.println(str1.substring(2, 5)+ " "+str1.substring(9, 12).toUpperCase());//my solution
		//1.Way
		...
		System.out.print((Integer.parseInt(s2)+Integer.parseInt(s3))/100.0);
		//valueOf() method do the same thing
